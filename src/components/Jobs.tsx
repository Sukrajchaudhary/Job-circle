        ...
        <div className="gap-6 lg:gap-8 grid w-full sm:grid-cols-2 md:grid-cols-3 p-3 ">
         {
          ...
          <Link to={`ViewJobsDetailsPages/${index}`}>  <div key={index} className="relative cursor-pointer rounded-xl p-6 space-y-4 border sm:border-gray-200 bg-white hover:shadow-lg transition-all ">
              <img
                alt="logo"
                loading="lazy"
                width={100}
